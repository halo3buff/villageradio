...
const PARA: React.CSSProperties = {
  fontFamily: BODY, fontSize: px(11), lineHeight: 1.22,
    ...
    <MobileStage>
      <div className="page-enter" style={{ position: 'absolute', inset: 0 }}>
        ...
        <Link href="/information" style={{
          position: 'absolute', left: px(35), top: px(96),
          fontFamily: SEGOE, fontSize: px(11), lineHeight: px(11),
          color: '#000', textDecoration: 'none',
        }}>README</Link>

        {/* Chromeless vectorscope */}
        <div style={{ position: 'absolute', left: px(17), top: px(117), width: px(368), height: px(400) }}>
          <MobileScope />
        </div>

        {/* Broadcast status — top-left of the scope box */}
        <div style={{
          position: 'absolute', left: px(24), top: px(124), width: px(320),
          fontFamily: BODY, fontSize: px(11), lineHeight: px(11), textTransform: 'uppercase',
        ...
        <div style={{
          position: 'absolute', left: px(285), top: px(125), width: px(92),
          textAlign: 'right', zIndex: 3, pointerEvents: 'none',
        }}>
          <div style={{ fontFamily: MONO, fontSize: px(7), lineHeight: px(12), fontVariantNumeric: 'tabular-nums' }}>
            <div style={{ color: '#000' }}>{clock.utc}</div>
            <div style={{ color: '#555' }}>{clock.mil}</div>
            <div style={{ color: RED, fontSize: px(6) }}>{clock.bc}</div>
          </div>
        </div>

        {/* Freq ticker — scrolling strip below the scope box */}
        <div style={{
          position: 'absolute', left: px(17), top: px(523), width: px(368), height: px(14),
          overflow: 'hidden', pointerEvents: 'none', zIndex: 3,
        }}>
          <div className="ticker" style={{
            fontFamily: MONO, fontSize: px(6), lineHeight: px(10), letterSpacing: '0.04em',
        ...
        {LOGO_OVAL_TOPS.map((t, i) => (
          <Image key={`ov-${i}`} src="/images/IMG_2411.png" alt="" aria-hidden width={LOGO_OVAL} height={LOGO_OVAL}
            style={{
              position: 'absolute', left: px(LOGO_OVAL_X), top: px(t),
              width: px(LOGO_OVAL), height: px(LOGO_OVAL),
        ...
        {LOGO_LETTERS.map((l, i) => (
          <span key={`lt-${i}`} aria-hidden style={{
            position: 'absolute', left: px(l.x), top: px(l.y),
            fontFamily: DISPLAY, fontSize: px(34),
        ...
        <div style={{ position: 'absolute', left: px(198), top: px(603), width: px(182), zIndex: 3, ...PARA }}>
          {`[STRUCTURE_01:VOID]
  0X1440X // STNSION
  <RECT:FILL_NULL>
...
E
        ...
        <div aria-hidden style={{
          position: 'absolute', left: px(315), top: px(623), width: px(36), zIndex: 3,
        ...
        {/* Censor bar 1 */}
        <div aria-hidden style={{
          position: 'absolute', left: px(195), top: px(660), width: px(156), height: px(9),
          background: '#000', zIndex: 5,
        }} />

        {/* Censor bar 2 */}
        <div aria-hidden style={{
          position: 'absolute', left: px(250), top: px(689), width: px(46), height: px(9),
          background: '#000', zIndex: 5,
        }} />

        {/* M1231 mirrored block */}
        <div style={{ position: 'absolute', left: px(298), top: px(641), width: px(97), zIndex: 3, transform: 'scaleX(-1)', transformOrigin: 'center', ...PARA }}>
...
M987.457`}
        ...
        {/* ░▒▓▓▒░ mirrored block */}
        <div style={{ position: 'absolute', left: px(293), top: px(745), width: px(102), zIndex: 3, transform: 'scaleX(-1)', transformOrigin: 'center', ...PARA }}>
...
8.364  1020.56  759.846  1019.39`}
        ...
        <Link href="/transmit" style={{
          position: 'absolute', left: px(31), top: px(778),
          fontFamily: DISPLAY, fontSize: px(32), lineHeight: px(31), letterSpacing: '-0.13em',
        ...
        <div aria-hidden style={{
          position: 'absolute', left: px(17), top: px(117), width: px(368), height: px(400),
